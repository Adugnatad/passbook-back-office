...
const Settings = () => {
  const [menuSelected, setMenuSelected] = useState<string>("Features");
  const [searchText, setSearchText] = useState<string>("");
  const menuClick = (menu: string) => {
    setMenuSelected(menu);
  };
  const menuList: string[] = ["Features"];
  const [filteredMenu, setFilteredMenu] = useState(menuList);

  useEffect(() => {
    const filtered = menuList.filter((menu) =>
      menu.toUpperCase().includes(searchText.toUpperCase())
    );
      ...
      <div className="flex flex-col items-start w-full md:flex-row">
        <div className="mt-[55px] mr-10 w-full md:w-[40%]">
          ...
          {filteredMenu.map((menu, index) => (
            <div
              key={index}
              className={`flex flex-row justify-start cursor-pointer py-2 px-4 border-[1px] text-[#9B9D9D] font-medium ${
                menuSelected === menu &&
                "border-l-[2px] border-l-[#3F85D3] text-[#3F85D3] bg-[#FAFAFA]"
              }`}
        ...
        <div className="w-full">
          {/* {menuSelected === "Ads" &&
                        <section className='flex flex-col w-full'>
                            <div className='mb-5 flex flex-col'>
                                <span className='mb-5 mt-5 font-medium text-[20px] sm:mt-0'>Ad Management</span>
                                <div>
          ...
          {menuSelected === "Features" && (
            <section className="flex flex-col w-full">
              <div className="mb-5 flex flex-col">
                <span className="mb-5 mt-5 font-medium text-[20px] sm:mt-0">
                  Features
                </span>
                <div>
                  <div className="flex flex-row items-center justify-center space-x-1 mb-4 sm:justify-start">
                    ...
                    <AiFillQuestionCircle
                      ...
                      data-tooltip-content="Toggle app features"
                    />
                  </div>
                  <div className="flex flex-col">
                    <div className="flex flex-col items-center justify-between border-[1px] border-[#CACCCF] px-2 py-3 sm:flex-row">
                      <div className="flex flex-col items-center mr-5 mb-5 sm:items-start sm:mb-0">
                        <span className="text-center sm:text-start sm:mb-1">
                          ATM Card Request
                        </span>
                        <span className="text-center sm:text-start">
                          Enable ATM Card Request Feature
                        </span>
                      </div>
                      <label className="relative cursor-pointer ">
                        <input
                    ...
                    <div className="flex flex-row items-center justify-between border-[1px] border-[#CACCCF] px-2 py-3">
                      <div className="flex flex-col items-start mr-5">
                        <span className="text-start mb-1">
                          Request Account Statement
                        </span>
                        <span className="text-start">
                          Enable Request Account Statement Feature
                        </span>
                      </div>
                      <label className="relative cursor-pointer ">
                        <input
                ...
                <button
                  className="self-end mt-4 bg-[#3F85D3] text-[#fff] px-3 py-1 rounded-lg"
                  onClick={handleSave}
                >
                  Save
                </button>
